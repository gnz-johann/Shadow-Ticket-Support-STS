...
const DashboardLayout = () => {
  ...
  const handlePagoSuscripcion = async (e) => {
    ...
    try {
      await axios.put(`https://shadow-ticket-support-backend-jace.onrender.com/api/cliente/${usuario.id}/suscripcion`, {
        id_plan: 2,
  ...
  const enviarReporte = async (e) => {
    ...
    try {
      await axios.post('https://shadow-ticket-support-backend-jace.onrender.com/api/soporte/reportar', {
