...
const GestionPersonal = () => {
  ...
  const obtenerPersonal = async () => {
    try {
      const respuesta = await axios.get('https://shadow-ticket-support-backend-jace.onrender.com/api/personal/tecnicos');
  ...
  const verTicketsAsignados = async (persona) => {
    ...
    try {
      const respuesta = await axios.get(`https://shadow-ticket-support-backend-jace.onrender.com/api/personal/tecnicos/${persona.id}/tickets`);
  ...
  const handleCrearTecnico = async (e) => {
    ...
    try {
      await axios.post('https://shadow-ticket-support-backend-jace.onrender.com/api/personal/tecnicos', {
        nombres: nuevoNombre,
        correo: nuevoCorreo,
        pass: nuevoPass
      });
